...
1. Push/open the PR and obtain a green exact pinned Ubuntu service-backed workflow as required by D-033.
2. Update D-008 with the acceptance outcome, move A03 to review, and obtain project-owner G3 approval before A04/A05.