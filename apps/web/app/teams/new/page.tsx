  ...
  return (
    <div className="max-w-2xl mx-auto py-4 space-y-6">
      <div className="border-b border-stone-250 dark:border-stone-850 pb-4">
        <h1 className="text-3xl font-bold font-serif text-[#000b60] dark:text-[#a5b4fc]">Form Capstone Team</h1>
        <p className="text-sm text-stone-500">Register a new student team to recruit members and apply for project claims.</p>
      </div>
        ...
        <Section title="Basic Group Metadata">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1">
              <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Team / Group Name</label>
              <input
                required
                value={name}
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Target Size (Students)</label>
              <input
                required
                type="number"
                min={2}
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Focus Discipline</label>
              <input
                required
                value={discipline}
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Group Visibility</label>
              <select
                value={visibility}
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Short Project Focus Summary</label>
            <textarea
              required
              value={description}
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Discord Group Link (Optional)</label>
            <input
              type="url"
              value={discordUrl}
        ...
        <Section title="Desired Roster Competencies">
          <div className="grid gap-6">
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400">Existing Skills In Group</label>
              <Combobox options={predefinedSkills} selected={existingSkills} onChange={setExistingSkills} />
            </div>
            <div className="space-y-1.5">
              <label className="text-[10px] font-bold uppercase tracking-wider text-stone-400 text-[#283593] dark:text-indigo-300">Desired Skills Needed From Recruits</label>
