...
INSERT INTO teams (
  ...
  ('91000000-0000-0000-0000-000000000001', 'Signal Foundry', 'Demo student team building decision tools for operations and campus services.', false, 6, 'SOEN', '90000000-0000-0000-0000-000000000001', 'RECRUITING', 'OFFER_RECEIVED', 'VISIBLE', 'https://discord.example/signal-foundry', ARRAY['React','Go','UX Research','Embedded'], ARRAY['Data Science','Controls'], ARRAY['Smart buildings','Energy analytics','Student services'], now() - interval '15 days'),
  ('91000000-0000-0000-0000-000000000002', 'Telemetry Guild', 'Data science team seeking a product-minded frontend lead.', false, 5, 'DATA', '90000000-0000-0000-0000-000000000006', 'RECRUITING', 'FORMING', 'VISIBLE', 'https://discord.example/telemetry-guild', ARRAY['Python','Data Science','Postgres'], ARRAY['React','UX Research'], ARRAY['Forecasting','Dashboards'], now() - interval '12 days'),
  ('91000000-0000-0000-0000-000000000003', 'Circuit Works', 'Embedded systems group already matched to a controls-heavy sponsor project.', true, 6, 'ELEC', '90000000-0000-0000-0000-000000000005', 'FULL', 'MATCHED', 'VISIBLE', 'https://discord.example/circuit-works', ARRAY['Embedded','Controls','Python'], ARRAY[]::text[], ARRAY['Robotics','Manufacturing'], now() - interval '25 days');
